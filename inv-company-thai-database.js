...
const inv_comp_thai_fetchBatchFromSupabase = async () => {
...
const inv_tax_thai_loadAllData = async () => {
    ...
    await inv_comp_thai_fetchBatchFromSupabase(); // assumes it fills inv_tax_thai_allFetchedData globally
